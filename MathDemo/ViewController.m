...
- (void)viewDidLoad
{
    ...
    // Demo formulae
    // Quadratic formula
    self.demoLabels[0] = [self createMathLabel:@"a/b -= alpha (d in RR)^42 ~= qz sqrt5" withHeight:60];
    ...
    self.demoLabels[1] = [self createMathLabel:@"\\frac{a}{b} \\equiv \\alpha {d \\in \\mathbb{R}}^{42} \\cong qz \\sqrt{5}" withHeight:80];
